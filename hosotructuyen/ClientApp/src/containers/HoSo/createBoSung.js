  ...
  return (
    <Col>
      ...
      >
        <Row gutter={[40, 40]}>
          <Col span={12}>
            <Form.Item name="TenDeTai" label="Tên đề tài"><Input disabled /></Form.Item>
            <Form.Item name="TenVietTat" label="Tên đề tài viết tắt"><Input disabled /></Form.Item>
            <Form.Item name="NghienCuuVien" label="Tên nghiên cứu viên chính / Chủ nhiệm đề tài"><Input disabled /></Form.Item>
            <Form.Item name="CoQuanThucHien" label="Cơ quan thực hiện / Chủ trì đề tài"><Input disabled /></Form.Item>
            <Form.Item name="CapQuanLy" label="Cấp quản lý"><Input disabled /></Form.Item>
          ...
          <Col span={12}>
            <Form.Item name="MaSoDeTai" label="Mã số đề tài"><Input disabled /></Form.Item>
            <Form.Item name="NhaTaiTro" label="Nhà tài trợ"><Input disabled /></Form.Item>
            <Row>
              <Col span={12}>
                <Form.Item name="LoaiHoSo" label="Phân loại hồ sơ"><Input disabled /></Form.Item>
              </Col>
              <Col span={1}></Col>
              <Col span={11}>
                <Form.Item
            ...
            <Form.Item name="LoaiDeTai" label="Phân loại đề tài"><Input disabled /></Form.Item>
